...
def _build_attendance_pdf_response_reportlab(sheets, exam_name):
    ...
    for page_meta in (sheets or [{}]):
        ...
        internal_line_left = page_width - right_margin - 178
        ...
        draw_line_label("Name (in CAPITAL):", ((internal_line_left + internal_line_right) / 2) - 50, internal_line_y - 19, 7)
        ...
        external_left = page_width - right_margin - 178
        ...
        draw_line_label("Name (in CAPITAL):", ((external_left + external_right) / 2) - 50, footer_row_2_line_y - 20, 7)
