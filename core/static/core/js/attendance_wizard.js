...
function showStep3(pages, examName){
  ...
  html += `
    ...
    html += `
      ...
      <div class="sheet-footer-row" style="margin-top:16px;">
      ...
      <div class="sheet-footer-row" style="margin-top:12px;">
      ...
      <div class="sheet-footer" style="display:flex; justify-content:space-between; align-items:center; padding-top:18px; margin-top:10px;">
